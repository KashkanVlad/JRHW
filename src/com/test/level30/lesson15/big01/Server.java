package com.test.level30.lesson15.big01;
...
/*
1. Запускаем Server
----(Сервер запущен)-----> В консоли
1.2 Вводим имя Порта:
    127.0.0.1

2. Запускаем ClientGuiController
2.1 Вводим адрес сервера:
    127.0.0.1
2.2 Вводим порт сервера:
    8080
2.3 Вводим имя пользователя:
    Vladislav
----(Соединение установлено.Для выхода наберите команду 'exit'.)----->Напишет в консоли
----(участник Vladislav присоединился к чату)-----> Напишет в консоли

3.0 Для запуска бота делаем тоже самое.
3.1 BotClient -> Run...
3.2 Вводим адрес и порт, как и в ClientGuiController
* */
