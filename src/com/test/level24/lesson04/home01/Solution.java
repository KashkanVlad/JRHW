package com.test.level24.lesson04.home01;

/* Рефакторинг
В классе Rectangle:
1. Измените методы castToHasHeight и castToHasWidth, чтобы они возвращали castToHasHeight и HasWidth соответственно.
